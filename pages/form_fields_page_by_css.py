...
class FormFieldsPageByCSS(BasePage):
    ...
    # Locators
    NAME_INPUT = ("css selector", "#name-input")
    PASSWORD_INPUT = (
        "css selector",
        "#feedbackForm > label:nth-child(3) > input[type=password]",
    )
    EMAIL_INPUT = ("css selector", "#email")
    MILK_CHECKBOX = ("css selector", "#drink2")
    COFFEE_CHECKBOX = ("css selector", "#drink3")
    YELLOW_RADIO = ("css selector", "#color3")
    AUTOMATION_DROPDOWN = ("css selector", "#automation")
    MESSAGE_FIELD = ("css selector", "#message")
    SUBMIT_BUTTON = ("css selector", "#submit-btn")
