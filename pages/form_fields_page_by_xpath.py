...
class FormFieldsPageByXPath(BasePage):
    ...
    # Locators
    NAME_INPUT = ("xpath", '//*[@id="name-input"]')
    PASSWORD_INPUT = ("xpath", '//*[@id="feedbackForm"]/label[2]/input')
    EMAIL_INPUT = ("xpath", '//*[@id="email"]')
    MILK_CHECKBOX = ("xpath", '//*[@id="drink2"]')
    COFFEE_CHECKBOX = ("xpath", '//*[@id="drink3"]')
    YELLOW_RADIO = ("xpath", '//*[@id="color3"]')
    AUTOMATION_DROPDOWN = ("xpath", '//*[@id="automation"]')
    MESSAGE_FIELD = ("xpath", '//*[@id="message"]')
    SUBMIT_BUTTON = ("xpath", '//*[@id="submit-btn"]')
    AUTOMATION_TOOLS_LIST = (
        "xpath",
        '//*[@id="feedbackForm"]/label[16]/following-sibling::ul/li',
    )
